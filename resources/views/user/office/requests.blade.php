            ...
            <div class="col-md-12 py-5">
                <div class="row px-0 pb-5">
                    <div class=" col-md-10 float-left">
                        <h3 style="font-family: 'Open Sans', sans-serif; letter-spacing: 2px;"><strong>ZOZNAM ŽIADOSTÍ</strong></h3>
                    </div>
                    @if($remains == 0)
                            ...
                            <div class="row my-5">
                                ...
                                <div class="card mx-4" style="width: 21.5%;">
                                    ...
                                    <div class="container pt-3 px-3">
                                        <h4><b>{{ $pending_users[$i]['surname'].' '.$pending_users[$i]['lastname'] }}</b></h4>
